...
with st.container(border=True):
    col_adv1, col_adv2 = st.columns() # 比率を2:1にしてボタンを大きく
    with col_adv1:
...
if is_market_closed:
    st.info(f"💡 **【アプリを見に来てくれた方へ】** 現在、アメリカの株式市場は**営業時間外（または定休日）**です。画面には**「直近の最終記録」**を綺麗に表示しています。平日の夜（日本時間 **{guide_time_str}**）にアクセスすると、リアルタイムにグングン動くチャートをご覧いただけます！")
